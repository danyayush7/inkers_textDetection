...
tf.app.flags.DEFINE_string('checkpoint_path', '/content/drive/resnet_train/', '')
tf.app.flags.DEFINE_boolean('restore', True, 'whether to restore from checkpoint')
tf.app.flags.DEFINE_integer('save_checkpoint_steps', 1000, '')
tf.app.flags.DEFINE_integer('save_summary_steps', 100, '')
tf.app.flags.DEFINE_string('pretrained_model_path', '/content/drive/resnet_train/model.ckpt-49494', '')
