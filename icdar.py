...
tf.app.flags.DEFINE_string('training_data_path', 'images/',
...
def get_images():  
    '''
    Get all images from given data path
    '''
    files = []
...
def check_and_validate_polys(polys, tags, dimension):
    '''
...
def get_batch(num_workers, **kwargs):
    try:
        ...
        print('Generator use 10 batches for buffering')
