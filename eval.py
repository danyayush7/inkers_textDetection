...
tf.app.flags.DEFINE_string('checkpoint_path', 'models/resnet_50_v1/', '') #'models/resnet_v2/'
tf.app.flags.DEFINE_string('output_dir', '50_v1/', '')
    ...
    with tf.get_default_graph().as_default():
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
            ...
            for im_fn in im_fn_list:
                ...
                print('timing for '+ str(z)+' images -> {}'.format(duration))
                print()
                z+=1
